...
?>
        ...
        <div class="container text-start m-auto w-75 min-vh-100">
            <div class="d-flex justify-content-center py-3">
                <div class="col-md-12"> 
                    <div class="card flex-md-row mb-4 box-shadow h-md-550"> 
                        <div class="card-body d-flex flex-column align-items-start">
                            <strong class="d-inline-block mb-2"><?php echo $book_row['book_name']; ?></strong>
                            <h3 class="mb-0">
                                <?php echo $book_row['book_price']; ?> TK
                            </h3>
