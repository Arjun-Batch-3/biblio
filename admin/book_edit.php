<?php
    ...
    #process_book_edit_category_id_data
...
?>
        ...
        <div class="container-fluid px-4 mt-4 w-50 mx-auto min-vh-100">
            <form class="rounded-4 shadow p-5" action="functions/process_book_edit.php" method="POST" enctype="multipart/form-data">
                <div class=" mb-4">
